...
class CustomColor {
  ...
  // static const Color scaffoldBg = Color.fromARGB(255, 248, 248, 248);
  static const Color bgLight1 = Color(0xff333646);
  // static const Color bgLight1 = Color.fromARGB(255, 229, 230, 236);
  static const Color bgLight2 = Color(0xff424657);
  // static const Color bgLight2 = Color.fromARGB(255, 240, 240, 242);
